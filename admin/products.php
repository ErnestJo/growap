...
$page = (int) (!isset($_GET["page"]) ? 1 : $_GET["page"]);
                ...
                $statement = "product ORDER BY pid DESC"; //you have to pass your query over here
                    ...
                    <div class="col-md-3">
                        <div class="card">
                          ...
                          <div class="card_box">
                            ...
                            <p class="text-center"><button onclick="deletepro(<?=$products['pid'];?>);" class="btn btn-block btn-sm btn-info">DELETE</button></p>
                          </div>
                        </div>
                    </div>
                <?php endwhile; ?>
